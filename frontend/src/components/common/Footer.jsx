    ...
    <footer className="relative bg-slate-950 text-white overflow-hidden" role="contentinfo">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 space-y-12">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>{footerData.copyrightText || '© 2026 Success Mantra. All rights reserved.'}</p>
          <div className="flex items-center gap-4 flex-wrap">
            <Link to="/about" className="hover:text-white transition">About Us</Link>
            <Link to="/contact" className="hover:text-white transition">Contact</Link>
            <Link to="/books" className="hover:text-white transition">Books Store</Link>
            <Link to="/courses" className="hover:text-white transition">Commerce Coaching</Link>
          </div>
        </div>
      </div>
    </footer>
