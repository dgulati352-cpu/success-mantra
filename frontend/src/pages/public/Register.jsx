      ...
      <main className="relative z-10 flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-2xl bg-white rounded-3xl sm:rounded-[2.5rem] border border-slate-200/90 shadow-2xl shadow-indigo-500/5 p-6 sm:p-10 md:p-12 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Proper Postal / Residential Address Section */}
            <div className="p-4 sm:p-5 rounded-2xl bg-indigo-50/40 border border-indigo-100/80 space-y-3.5">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="e.g. House No. 42, Sector 14, Near Community Center"
                    value={formData.address || ''}
                    onChange={e => setFormData({ ...formData, address: e.target.value })}
                    className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-600 focus:ring-4 focus:ring-indigo-500/10 transition-all font-medium"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-600 block">City / Town</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-3 py-2 bg-white border border-slate-200 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-600 focus:ring-4 focus:ring-indigo-500/10 transition-all font-medium"
                    />
                  </div>
                </div>

                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-600 block">State / UT</label>
                  <div className="relative">
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-600 block">PIN / Postal Code</label>
                  <div className="relative">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  {confirmPassword && (
                    <span className={`text-[10px] font-bold flex items-center gap-1 ${
                      formData.password === confirmPassword ? 'text-emerald-600' : 'text-rose-500'
                    }`}>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-10 py-2.5 bg-slate-50/70 border rounded-2xl text-xs text-slate-900 placeholder-slate-400 focus:bg-white focus:outline-none focus:ring-4 transition-all font-medium ${
