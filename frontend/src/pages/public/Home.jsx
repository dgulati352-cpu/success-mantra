...
export function Home() {
  ...
  return (
    <div className="space-y-24 sm:space-y-32 pb-24 overflow-hidden">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base sm:text-xl text-slate-600 max-w-3xl mx-auto font-normal leading-relaxed">
              {heroData.subheading || 'Buy Class 12 Accountancy, Business Studies & Economics MCQ Books for CBSE and CUET. Success Mantra also offers Class 11 & 12 Commerce coaching in Saharanpur.'}
            </p>
          </div>
      ...
      {/* 2. PRIMARY MONEY KEYWORD CLUSTER: CLASS 12 COMMERCE MCQ BOOKS */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div className="space-y-2 max-w-2xl">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl font-black text-slate-900">
              Class 12 Commerce <span className="gradient-text-purple">MCQ Books & Question Banks</span>
            </h2>
            <p className="text-xs sm:text-sm text-slate-600">
              Comprehensive practice books with chapter-wise MCQs, 1 Mark Questions, and Assertion-Reason questions designed specifically for CBSE Board and CUET UG Commerce aspirants.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Accountancy Book Card */}
          <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-7 shadow-md hover:shadow-2xl transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1.5">
            <div className="space-y-4">
              <Link to="/books/class-12-accountancy-mcq-book" className="block relative h-56 rounded-2xl overflow-hidden bg-slate-950/5 p-3 flex items-center justify-center">
                <img
                  src="https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=600"
                  alt="Class 12 Accountancy MCQ Book for CBSE and CUET"
                  className="h-full max-w-[160px] object-cover rounded-xl shadow-md group-hover:scale-105 transition duration-300"
                  width="160"
                  height="210"
                  loading="lazy"
                />
                <span className="absolute top-3 left-3 text-[10px] font-black uppercase px-2.5 py-0.5 rounded-full bg-indigo-600 text-white">
                  Accountancy
                </span>
                <span className="absolute top-3 right-3 text-[10px] font-black px-2 py-0.5 rounded-md bg-emerald-600 text-white">
                  40% OFF
                </span>
              </Link>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  <span className="text-slate-500 font-bold">Class 12 • CBSE & CUET</span>
                  <div className="flex items-center gap-1 text-amber-500 font-bold">
                    <Star className="w-3.5 h-3.5 fill-amber-400" />
                    <span>4.96 (342 reviews)</span>
                  </div>
                </div>

                <h3 className="font-heading font-black text-slate-900 text-lg leading-snug group-hover:text-indigo-600 transition">
                  <Link to="/books/class-12-accountancy-mcq-book">
                    Class 12 Accountancy MCQ Book
                  </Link>
                </h3>

                <p className="text-xs text-slate-500 line-clamp-3 leading-relaxed">
                  Prepare for Class 12 Accountancy with chapter-wise MCQs, 1 Mark Questions, and exam-focused question bank for CBSE and CUET.
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 mt-4 space-y-3">
              ...
              <Link
                to="/books/class-12-accountancy-mcq-book"
                className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs text-center flex items-center justify-center gap-1.5 transition shadow-md shadow-indigo-500/20"
              >
                <span>Explore the Class 12 Accountancy MCQ Book</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>

          {/* Business Studies Book Card */}
          <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-7 shadow-md hover:shadow-2xl transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1.5">
            <div className="space-y-4">
              <Link to="/books/class-12-business-studies-mcq-book" className="block relative h-56 rounded-2xl overflow-hidden bg-slate-950/5 p-3 flex items-center justify-center">
                <img
                  src="https://images.unsplash.com/photo-1589829085413-56de8ae18c73?w=600"
                  alt="Class 12 Business Studies MCQ Book for CBSE and CUET"
                  className="h-full max-w-[160px] object-cover rounded-xl shadow-md group-hover:scale-105 transition duration-300"
                  width="160"
                  height="210"
                  loading="lazy"
                />
                <span className="absolute top-3 left-3 text-[10px] font-black uppercase px-2.5 py-0.5 rounded-full bg-purple-600 text-white">
                  Business Studies
                </span>
                <span className="absolute top-3 right-3 text-[10px] font-black px-2 py-0.5 rounded-md bg-emerald-600 text-white">
                  38% OFF
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <div className="flex items-center gap-1 text-amber-500 font-bold">
                    <Star className="w-3.5 h-3.5 fill-amber-400" />
                    <span>4.92 (218 reviews)</span>
                  </div>
                </div>

                <h3 className="font-heading font-black text-slate-900 text-lg leading-snug group-hover:text-indigo-600 transition">
                  <Link to="/books/class-12-business-studies-mcq-book">
                    Class 12 Business Studies MCQ Book
                  </Link>
                </h3>

                <p className="text-xs text-slate-500 line-clamp-3 leading-relaxed">
                  Prepare for Class 12 Business Studies with exam-focused MCQs, 1 Mark Questions, case studies, and question bank for CBSE and CUET.
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 mt-4 space-y-3">
              ...
              <Link
                to="/books/class-12-business-studies-mcq-book"
                className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs text-center flex items-center justify-center gap-1.5 transition shadow-md shadow-indigo-500/20"
              >
                <span>Explore the Class 12 Business Studies MCQ Book</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-7 shadow-md hover:shadow-2xl transition-all duration-300 flex flex-col justify-between group hover:-translate-y-1.5">
            <div className="space-y-4">
              <Link to="/books/class-12-economics-mcq-book" className="block relative h-56 rounded-2xl overflow-hidden bg-slate-950/5 p-3 flex items-center justify-center">
                <img
                  src="https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600"
                  alt="Class 12 Economics MCQ Book for CBSE and CUET"
                  className="h-full max-w-[160px] object-cover rounded-xl shadow-md group-hover:scale-105 transition duration-300"
                  width="160"
                  height="210"
                  loading="lazy"
                />
                <span className="absolute top-3 left-3 text-[10px] font-black uppercase px-2.5 py-0.5 rounded-full bg-emerald-600 text-white">
                  Economics
                </span>
                <span className="absolute top-3 right-3 text-[10px] font-black px-2 py-0.5 rounded-md bg-emerald-600 text-white">
                  39% OFF
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <div className="flex items-center gap-1 text-amber-500 font-bold">
                    <Star className="w-3.5 h-3.5 fill-amber-400" />
                    <span>4.89 (185 reviews)</span>
                  </div>
                </div>

                <h3 className="font-heading font-black text-slate-900 text-lg leading-snug group-hover:text-indigo-600 transition">
                  <Link to="/books/class-12-economics-mcq-book">
                    Class 12 Economics MCQ Book
                  </Link>
                </h3>

                <p className="text-xs text-slate-500 line-clamp-3 leading-relaxed">
                  Prepare for Class 12 Economics with MCQs, 1 Mark Questions, formula sheets, and question banks for Macroeconomics and Indian Economic Development.
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 mt-4 space-y-3">
              <div className="flex items-baseline justify-between">
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl font-black text-slate-900">₹549</span>
              ...
              <Link
                to="/books/class-12-economics-mcq-book"
                className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs text-center flex items-center justify-center gap-1.5 transition shadow-md shadow-indigo-500/20"
              >
                <span>Explore the Class 12 Economics MCQ Book</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>
      ...
      {/* 4. EXPLORE OUR PROGRAMS & SAHARANPUR COACHING */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div className="space-y-2">
            <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full border border-indigo-100">
          ...
          {[
            {
              ...
              desc: 'Accountancy, BST & Macroeconomics master series with CBSE 10-year papers and MCQ drills.',
              badge: 'Most Popular',
            ...
            },
            {
              ...
              desc: 'NTA pattern CBT mock exams, domain subjects, and speed hackathons for top universities.',
              badge: 'Entrance Exam',
      ...
      {/* 5. HIGH-DEFINITION VIDEO LECTURES SHOWCASE */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
      ...
      {/* 7. VIP MEMBERSHIP ALL-ACCESS PASS */}
