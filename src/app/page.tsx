        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 bg-blue-500/20 text-blue-300 rounded-full text-xs font-bold border border-blue-400/30">
              ...
              <span>Class 11 & 12 Commerce (Without Maths) Portal</span>
            </div>
            ...
            <p className="text-base text-slate-300 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Complete Accountancy, Business Studies, Economics & Entrepreneurship video lectures, handwritten faculty PDF notes, timed CBSE & CUET mock tests, and official hardcopy book store.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/10 max-w-md mx-auto lg:mx-0 text-center lg:text-left">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 font-medium">CBSE Commerce Pass</p>
              </div>
              <div>
            ...
            <div className="relative bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden p-4 space-y-4">
              ...
              <div className="flex items-center justify-between bg-slate-800/80 p-3 rounded-xl text-xs">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-bold text-white">Commerce Batch (Non-Maths)</span>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-black text-slate-900">
            Everything You Need for Commerce Distinction
          </h2>
          <p className="text-xs sm:text-sm text-slate-500">
            Tailored learning modules engineered specifically for Class 11 & 12 Commerce (Without Maths), CA Foundation & CUET.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition space-y-4">
            ...
            <h3 className="text-lg font-bold text-slate-900">HD Commerce Video Player</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Dynamic playlist sidebar, variable speed controls (0.5x - 2.0x), custom timeline seeking, and attached T.S. Grewal solutions PDF notes right below the video.
            </p>
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition space-y-4">
            ...
            <h3 className="text-lg font-bold text-slate-900">Timed Commerce Mock Test Engine</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs hover:shadow-md transition space-y-4">
            ...
            <h3 className="text-lg font-bold text-slate-900">Official Printed Commerce Bookstore</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
            ...
            <Link href="/store" className="text-xs font-bold text-indigo-600 hover:underline inline-flex items-center gap-1">
              Explore Commerce Bookstore <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </div>
        </div>
      </section>
